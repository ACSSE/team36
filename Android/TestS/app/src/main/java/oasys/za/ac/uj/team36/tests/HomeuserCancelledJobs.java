...
public class HomeuserCancelledJobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeuser_cancelled_jobs);
    ...
    public void fetchRequests(){
        ...
        MyRequestJArray request = new MyRequestJArray(SERVER_ADDRESS_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(allRequests.length()>0){
                    ...
                    Toast.makeText(HomeuserCancelledJobs.this,"No Requests To Display",Toast.LENGTH_LONG) ;
                }
                // displayAllRequests();
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                AlertDialog.Builder d = new AlertDialog.Builder(HomeuserCancelledJobs.this);
        ...
        MySingleton.getInsance(HomeuserCancelledJobs.this).addToRequestQueue(request);
    }
        ...
        if(numItemsInList > 0) {
            try {
                for (int i = 0; i < numItemsInList; i++) {
                    if(allRequests.getJSONObject(i).has("JobStatus-0")){
                        int notify = allRequests.getJSONObject(i).getInt("JobStatus-0");
                        if(notify == 2){
    ...
    public void populateListView(String[] req, int length){
        if(length > 0) {
            ...
            ListView listView = (ListView) findViewById(R.id.lvOngoingHU);
