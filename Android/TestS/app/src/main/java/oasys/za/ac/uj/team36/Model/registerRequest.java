...
public class registerRequest extends StringRequest {
    ...
    public registerRequest(String name, String surname, String username, int IDn, int phoneN, String email, String password,int type, Response.Listener<String> listener){
