...
public class HomeuserFinishedJobs extends AppCompatActivity {
    ...
    public void fetchRequests(){
        ...
        MyRequestJArray request = new MyRequestJArray(SERVER_ADDRESS_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(allRequests.length()>0){
                    ...
                    Toast.makeText(HomeuserFinishedJobs.this,"No Requests To Display",Toast.LENGTH_LONG) ;
                }
                // displayAllRequests();
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                AlertDialog.Builder d = new AlertDialog.Builder(HomeuserFinishedJobs.this);
        ...
        MySingleton.getInsance(HomeuserFinishedJobs.this).addToRequestQueue(request);
    }
