...
public class registerRequest extends StringRequest {
    ...
    public registerRequest(int type,String name, String surname, String username, int IDn, int phoneN,
                           String email, String password,int strnum,String strname, String subA,String area,
                           String adminA,String Skill, Response.Listener<String> listener){
