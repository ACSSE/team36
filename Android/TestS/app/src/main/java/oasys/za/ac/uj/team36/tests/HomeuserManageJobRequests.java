...
public class HomeuserManageJobRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeuser_manage_job_requests);
    ...
    public void fetchRequests(){
        ...
        MyRequestJArray request = new MyRequestJArray(SERVER_ADDRESS_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                handleRequests() ;
                    ...
                    Toast.makeText(HomeuserManageJobRequests.this,"No Requests To Display",Toast.LENGTH_LONG) ;
                }
                // displayAllRequests();
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                AlertDialog.Builder d = new AlertDialog.Builder(HomeuserManageJobRequests.this);
        ...
        MySingleton.getInsance(HomeuserManageJobRequests.this).addToRequestQueue(request);
    }
    ...
    public void editRequest(){
        ...
        d.setNeutralButton("Send", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if((comenceDate != null && !newDescriptionString.isEmpty())){
                    //send request to edit details
                    sendEditRequestToServer();
                }else{
                    Toast.makeText(HomeuserManageJobRequests.this, "Could not perform edit",Toast.LENGTH_LONG) ;
                }
            }
        });
    ...
    public void deleteRequest(int position){
        ...
        MyRequestString deleteR = new MyRequestString(SERVER_ADDRESS_URL, params, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response.equalsIgnoreCase("true")) {
                    ...
                    Toast.makeText(HomeuserManageJobRequests.this, "Job could not be deleted", Toast.LENGTH_LONG);
                }
            }
        }, new Response.ErrorListener() {
            @Override
        ...
        MySingleton.getInsance(HomeuserManageJobRequests.this).addToRequestQueue(deleteR);
    }
    ...
    // below are the functions used to set the date
    ...
    private void showDate() {
        dateView = (TextView) findViewById(R.id.textView3Date);
        dateView.setText(comenceDate.toString());
    ...
    private DatePickerDialog.OnDateSetListener myDateListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker arg0, int arg1, int arg2, int arg3) {
            comenceDate.set(arg1,arg2+1,arg3);
        }
    };
}
