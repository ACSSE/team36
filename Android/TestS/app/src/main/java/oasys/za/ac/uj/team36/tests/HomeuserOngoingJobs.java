...
public class HomeuserOngoingJobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeuser_ongoing_jobs);
    ...
    public void fetchRequests(){
        ...
        MyRequestJArray request = new MyRequestJArray(SERVER_ADDRESS_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(allRequests.length()>0){
                    ...
                    Toast.makeText(HomeuserOngoingJobs.this,"No Requests To Display",Toast.LENGTH_LONG) ;
                }
                // displayAllRequests();
            }
        ...
        MySingleton.getInsance(HomeuserOngoingJobs.this).addToRequestQueue(request);
    }
            ...
            try {
                for (int i = 0; i < numItemsInList; i++) {
                    if(allRequests.getJSONObject(i).has("Status-0") && allRequests.getJSONObject(i).has("HomeuserResponse-0")) {
                        ...
                        int hr = allRequests.getJSONObject(i).getInt("HomeuserResponse-0");
                        if(status == 3 && hr == 3) {
