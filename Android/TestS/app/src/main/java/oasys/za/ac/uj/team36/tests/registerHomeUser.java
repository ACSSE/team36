...
public class registerHomeUser extends AppCompatActivity {


    private static final String DB_URL = "http://10.0.0.6:31335/php/classes/SebenzaServer.php" ;
    private Button bRegisterHomeUser;
    private EditText etUsername ,etPassword, etEmail, etPhone, etName, etSurname,etID ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_register_home_user, menu);
        return true;
    }
