...
public class HomeuserManageCompletedJobRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeuser_manage_completed_job_requests);
    ...
    public void fetchRequests(){
        ...
        MyRequestJArray request = new MyRequestJArray(SERVER_ADDRESS_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if(allRequests.length()>0){
                    ...
                    Toast.makeText(HomeuserManageCompletedJobRequests.this,"No Requests To Display",Toast.LENGTH_LONG) ;
                }
                // displayAllRequests();
            }
        ...
        MySingleton.getInsance(HomeuserManageCompletedJobRequests.this).addToRequestQueue(request);
    }
