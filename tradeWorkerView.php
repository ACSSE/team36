    ...
    <div class="row" style="min-height:400px">
        <div class="large-4 large-offset-4 columns">
            <ul class="menu vertical">
                <li><a href="#"  class="secondary button"><i class="fi-list"></i> <span>Manage Job Requests</span></a></li>
                <li><a href="#"  class="secondary button"><i class="fi-list"></i> <span>Manage Profile</span></a></li>
                <li><a href="#"  class="secondary button"><i class="fi-list"></i> <span>View Work History</span></a></li>
